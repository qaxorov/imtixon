...
export const Location = () => {
  ...
  const api = `https://rickandmortyapi.com/api/location/${caractersid}`;
  const api2 = `https://rickandmortyapi.com/api/location/?name=${text}`;
      ...
      <Box>
        <div className="container">
          <Content>
            ...
            <Text>Air Date: {data.dimension}</Text>
